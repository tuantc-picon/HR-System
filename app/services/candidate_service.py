...
class CandidateService(BaseService[Candidate]):
    ...
    async def create_candidate_with_cv(
        ...
        result = {"candidate": candidate, "resume": None, "upload_info": None}
    ...
    def update_candidate(
        self, db: Session, candidate_id: int, candidate_data: CandidateUpdateRequest
    ) -> Optional[Candidate]:
    ...
    def search_candidates_by_name(
        self, db: Session, name_keyword: str
    ) -> List[Candidate]:
